...
var hideAlert = exports.hideAlert = function hideAlert() {
  var el = document.querySelector('#here-success');
  if (el) {
...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  hideAlert();
  var print = "<div id=\"here-success\" class=\"".concat(type, "\">\n       <h2>").concat(msg, "</h2>\n      </div>");
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('green', 'Logged in');
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('red', 'Error loging out!');
        case 10:
        case "end":
...
},{"axios":"../node_modules/axios/index.js","./alerts":"alerts.js"}],"updates.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var loginForm = document.querySelector('.main-block');
var signupForm = document.querySelector('.main-block2');
var logoutForm = document.querySelector('#logout');
var formUpdate = document.getElementById('form101');
var formUpdate2 = document.getElementById('form102');
if (loginForm) {
  document.querySelector('.main-block').addEventListener('submit', function (e) {
    e.preventDefault();
...
if (logoutForm) {
  document.querySelector('#logout').addEventListener('click', _login.logout);
}
if (formUpdate) {
  formUpdate.addEventListener('submit', function (e) {
    ...
    (0, _updates.updateUserData)(form);
    document.getElementById('textt').value = "";
    document.getElementById('emaill').value = "";
  });
}
if (formUpdate2) {
  formUpdate2.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            currentPassword = document.getElementById('cp').value;
            password = document.getElementById('np').value;
            passwordConfirm = document.getElementById('cnp').value;
            console.log(currentPassword, password, passwordConfirm);
            _context.next = 7;
            return (0, _updates.updatePassword)(currentPassword, password, passwordConfirm);
          case 7:
